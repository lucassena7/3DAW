<?php
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $estado = $_POST["estado"];
        $cep = $_POST["cep"];
		$nomeArquivo = $nome . "_" . $matricula . ".txt"; //vai criar um aquivo para cada aluno
		//Escrever os dados do formulário em um arquivo de dados txt
		$arquivoAluno = fopen($nomeArquivo, "w"); //arvuivoAluno é uma variável que aponta para o arquivo nomeArquivo txt, o W significa Write
		...
		//Esse formato serve para criar 1 arquivo para cada pessoa.
	}
?>
...
<br>
<a href="Ex13_inserirAlunoDinamico.php">Inserir Aluno</a><br>
...
<br>
<form action="Ex13_inserirAlunoDinamico.php" method=POST>
