<?php
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		//$txt ="\n". $nome . ";" . $matricula . ";" . $email . ";" . $fone . ";" . $dtNasc . ";" . $cpf . ";" . $endereco . ";" . $cidade . ";" . $estado . ";" . $cep ; //Solucao TABAJARA
		file_put_contents("alunoNovo.txt", $txt, FILE_APPEND); //insere os dados de txt no final de alunoNovo, se o aruivo já existir, se nao existir, ele cria.
		//fwrite("alunoNovo.txt", $txt, FILE_APPEND); //gravando da 2 linha em diante com os dados do aluno, a primeira linha armazena as aos dados
		//fclose($arquivoAluno);//fechando o arquivo
		
		//Esse formato cria um arquivo se nao existir, e se existir, ele escreve no final. Se o arquivo não existir, ele nao coloca o cabeçalho
	}
?>
...
<br>
<a href="refazendoEx13_inserirAlunoAppend.php">Inserir Aluno</a><br>
...
<br>
<form action="refazendoEx13_inserirAlunoAppend.php" method=POST>
